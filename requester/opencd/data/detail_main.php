        	...
        	<div class="row">
            	<div class="col-md-12">
                    <div id="pn1" class="panel panel-primary">
                    	<div id="pnh1" class="panel-heading"> <i class="ti-comment-alt"></i> รายการขออนุมัติเครดิต (Credit Approval List) พนักงานขาย</div>
  												<div class="panel-body">
															<div id="a2"></div>
                            </div>
                        <div class="panel-footer" style="text-align:right;">
                          <button type="button" id="RefreshReq" class="btn btn-info" onClick="refreshpage();"><i class="ti-reload"></i> Refresh</button>
													<button type="button" id="" class="btn btn-default" onClick="customer();"><i class="glyphicon glyphicon-user"></i> ลูกค้า</button>
