  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="row">
        <div class="col-md-3">
            <div id="a01" class="form-group">
                <label>รหัสลูกค้า</label>
                  <input type='text' class="form-control border-input" id="customer_codeE" placeholder="Customer code" value="<?=$cuscode?>" disabled>
            </div>
        </div>
      </div>
			<div class="row">
        <div class="col-md-3">
            <div id="a02" class="form-group">
                <label>วันที่ *</label>
                  <input type='text' class="form-control border-input" id="open_dateE" placeholder="Submit Date" value="<?=$dateopen?>" disabled/>
              </div>
          </div>
          <script type="text/javascript">
          ...
          <div class="col-md-3">
            <div id="a03" class="form-group">
                ...
                <select class="form-control" id="open_typeE" disabled>
          ...
          <div class="col-md-6">
            <div id="a04" class="form-group">
                <label>ประเภทกิจการอื่นๆ</label>
                  <input type="text" class="form-control border-input" placeholder="กรอกข้อมูลถ้าเลือกอื่นๆ" id="open_otherE" value="<?=$cusopenoth?>" disabled>
            </div>
          </div>
        <?php } ?>
			</div>
      <div class="row">
        <div class="col-md-6">
          <div id="a05" class="form-group">
              <label>ชื่อกิจการ/หน่วยงานที่จดทะเบียน *</label>
                <input type="text" class="form-control border-input" placeholder="Business Name" id="open_businameE" value="<?=$cuscomname?>" disabled>
        ...
        <div class="col-md-3">
            <div id="a06" class="form-group">
              ...
              <input type="text" class="form-control border-input" placeholder="Business Location" id="open_busilocaE" value="<?=$cusaddno?>" disabled>
        ...
        <div class="col-md-3">
            <div id="a07" class="form-group">
              <label>หมู่ที่ *</label>
              <input type="text" class="form-control border-input" placeholder="Business Swine" id="open_busiswineE" value="<?=$cusmno?>" disabled>
      ...
      <div class="row">
          <div class="col-md-3">
            	...
            	<label>ถนน *</label>
            	<input type="text" class="form-control border-input" placeholder="Business Road" id="open_busiroadE" value="<?=$cusroad?>" disabled>
          	</div>
					</div>
          <div class="col-md-3">
						<div id="a09" class="form-group">
            	<label>ตรอก/ซอย *</label>
            	<input type="text" class="form-control border-input" placeholder="Business Alley" id="open_busialleyE" value="<?=$cusalley?>" disabled>
          ...
          <div class="col-md-3">
            ...
            <label>จังหวัด *</label>
            <select class="form-control" id="open_busiprovinE" disabled>
          ...
          <div class="col-md-3">
            ...
            <label>อำเภอ *</label>
            <select class="form-control" id="open_busiamphurE" disabled>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <label>ตำบล *</label>
          <select class="form-control" id="open_busidistrictE" disabled>
        ...
        <div class="col-md-3">
          ...
          <select class="form-control" id="open_busizipcodeE" disabled>
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control border-input" placeholder="Telephone" id="open_phoneE" value="<?=$cusphone?>" disabled>
        ...
        <div class="col-md-3">
          ...
          <label>แฟกซ์</label>
          <input type="text" class="form-control border-input" placeholder="Fax" id="open_faxE" value="<?=$cusfax?>" disabled>
				</div>
			</div>
      </div>
      <div class="row">
        ...
        <form>
            <label class="radio-inline">
              <input type="radio" name="optradio" value="1" id="open_typeproject1E" <? if($objec==1){ ?> checked='checked' <? } ?> disabled ><b>นำสินค้าไปจำหน่าย (ร้านค้า)</b>
            </label>
            <label class="radio-inline">
              <input type="radio" name="optradio" value="2" id="open_typeproject2E" <? if($objec==2){ ?> checked='checked' <? } ?> disabled><b>ใช้กับการก่อสร้างหน่วยงาน/</b>
            </label>
        </form>
			</div>
		</div>
    <? if($objec==2){ ?>
      <div class="col-md-6" id="a16">
        	...
        	<input type="text" class="form-control border-input" placeholder="Project Name" id="open_nameprojectE" value="<?=$proname?>" disabled>
				</div>
			</div><? }?>
    </div>
    <? if($objec==2){ ?>
      <div class="row">
				<div class="col-md-12" id="a17">
					<div id="a17" class="form-group">
						<label>ที่ตั้ง</label>
						<input type="text" class="form-control border-input" placeholder="Project Location" id="open_locaprojectE" value="<?=$constru?>" disabled>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4" id="a18">
					<div id="a18" class="form-group">
						...
						<form class="form-inline">
							<input type="number" class="form-control border-input" placeholder="Project Limitday" id="open_dateprojectE" value="<?=$promise?>" disabled><b> วัน</b>
						</form>
					</div>
				</div>
				<div class="col-md-4" id="a19">
					<div id="a19" class="form-group">
						...
						<input type="text" class="form-control border-input" placeholder="Project Date Start" id="open_dateprostartE" value="<?=$startproj?>" disabled>
					</div>
				</div>
				<script type="text/javascript">
				...
				<div class="col-md-4" id="a20">
					<div id="a20" class="form-group">
						<label>สิ้นสุด</label>
									<input type='text' class="form-control border-input" placeholder="Project Date End" id="open_dateproendE" value="<?=$endproj?>" disabled>
							</div>
				</div>
					<script type="text/javascript">
			...
			<div class="row">
				<div class="col-md-4" id="a21">
					...
					<form class="form-inline">
						<input type="text" class="form-control border-input" placeholder="Project Value" id="open_promonE" value="<?=$convalue?>" disabled><b> บาท</b>
					</form>
					</div>
				</div>
	            ...
	            <div id="a22" class="form-group">
	                <label>เริ่มใช้สินค้า (ป/ด/ว)</label>
	                  <input type='text' class="form-control border-input" placeholder="Project Get Started" id="proget_startE" value="<?=$startprod?>" disabled>
	              </div>
	        </div>
	          <script type="text/javascript">
			...
			<div class="row" id="a23">
	                ...
	                <select class="form-control" id="project_typeE" disabled>
          ...
          <?php if ($proty == 8) { ?>
            ...
            <div id="a24" class="form-group">
                <label>ประเภทงานก่อสร้างอื่นๆ</label>
                  <input type="text" class="form-control border-input" placeholder="กรอกข้อมูลถ้าเลือกอื่นๆ" id="project_otherE" value="<?=$prooth?>" disabled>
            </div>
          </div>
        <?php } ?>
			</div>
				...
				<div class="col-md-6">
					<div id="a25" class="form-group">
							<label>ประมาณการซื้อเฉลี่ย ต่อเดือน</label>
								<input type="text" class="form-control border-input" placeholder="Average Buy" id="project_averagebuyE" value="<?=$buildingm?>" disabled>
					</div>
				</div>
				<div class="col-md-6">
					<div id="a26" class="form-group">
							<label>ประมาณการซื้อรวมต่อปี</label>
								<input type="text" class="form-control border-input" placeholder="Buy Total" id="project_buytotalE" value="<?=$sumbuild?>" disabled>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
							...
							<form>
			          <label class="radio-inline">
			            <input type="radio" name="optradio" value="1" id="delivery1E" <? if($transpo==1){ ?> checked='checked' <? } ?> disabled><b>สำนักงานใหญ่ ตามที่อยู่ข้างต้น</b>
			          </label>
			          <label class="radio-inline">
			            <input type="radio" name="optradio" value="2" id="delivery2E" <? if($transpo==2){ ?> checked='checked' <? } ?> disabled><b>กรณีที่อยู่ไม่ตรงกับสำนักงานใหญ่ ให้แนบใบแจ้งสถานที่ส่งสินค้า</b>
			          </label>
			        </form>
					</div>
				</div>
				...
				<div class="col-md-12">
					...
					<div id="a27" class="form-group">
						<label>การชำระค่าสินค้า</label>
							<select class="form-control" id="pay_typeE" disabled>
				...
				<div class="col-md-8">
					<div id="a28" class="form-group">
							<label>การชำระค่าสินค้าทางอื่นๆ</label>
								<input type="text" class="form-control border-input" placeholder="กรอกข้อมูลถ้าเลือกอื่นๆ" id="pay_otherE" value="<?=$payoth?>" disabled>
					</div>
				</div>
      <?php } ?>
			</div>
			<div class="row">
				<div class="col-md-4" id="">
					...
					<form class="form-inline">
						<input type="number" class="form-control border-input" placeholder="Payment deadline" id="pay_deadlineE" value="<?=$daypay?>" disabled><b> วัน</b>
					</form>
					</div>
				</div>
	            ...
	            <div id="a30" class="form-group">
	                <label>สถานที่วางบิล </label>
	                  <input type='text' class="form-control border-input" placeholder="Billing location" id="pay_locabillE" value="<?=$billloc?>" disabled>
	             </div>
	       </div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
							...
							<form>
								<label class="radio-inline">
									<input type="radio" name="optradio" value="1" id="billing1E" <? if($foemal==1){ ?> checked='checked' <? } ?>  disabled><b>ต้องมี PO ใบสั่งซื้อ</b>
								</label>
								<label class="radio-inline">
									<input type="radio" name="optradio" value="2" id="billing2E" <? if($foemal==2){ ?> checked='checked' <? } ?>  disabled><b>เงื่อนไขอื่น ๆ</b>
								</label>
							</form>
					</div>
				</div>
				...
				<div class="col-md-8">
					<div id="a31" class="form-group">
							<label>เงื่อนไขอื่น ๆ</label>
								<input type="text" class="form-control border-input" placeholder="กรอกข้อมูลถ้าเลือกอื่นๆ" id="billing_otherE" value="<?=$foemaloth?>" disabled>
					</div>
				</div>
        <?php } ?>
			</div>
			<div class="row">
				...
				<div class="col-md-3">
					...
					<label>1) ร้านค้าที่เคยติดต่อ</label>
						<input type="text" class="form-control border-input" placeholder="Merchants contacted" id="contacted_openE" value="<?=$shopconta?>" disabled>
				</div>
				</div>
				<div class="col-md-3">
					<div id="a33" class="form-group">
					<label>สินค้า</label>
						<input type="text" class="form-control border-input" placeholder="Merchants contacted" id="product_openE" value="<?=$product?>" disabled>
					</div>
				</div>
				<div class="col-md-2">
					<div id="a34" class="form-group">
					<label>วงเงิน</label>
						<input type="number" class="form-control border-input" placeholder="Merchants contacted" id="product_monE" value="<?=$crdlimit?>" disabled>
					</div>
				</div>
				<div class="col-md-4">
					<div id="a35" class="form-group">
						<label>เครดิต</label>
					<form class="form-inline">
						<input type="number" class="form-control border-input" placeholder="Merchants contacted" id="product_creditE" value="<?=$crdday?>" disabled><b> วัน</b>
					<form>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-5">
					...
					<label>2) ธนาคารที่ติดต่อ</label>
						<input type="text" class="form-control border-input" placeholder="Contact bank" id="bank_openE" value="<?=$namebank?>" disabled>
					</div>
				</div>
				<div class="col-md-4">
					<div id="a37" class="form-group">
					<label>สาขา</label>
						<input type="text" class="form-control border-input" placeholder="Branch bank" id="bankbran_openE" value="<?=$branbank?>" disabled>
					</div>
				</div>
				<div class="col-md-3">
					<div id="a38" class="form-group">
						<label>เลขที่บัญชี</label>
						<input type="text" class="form-control border-input" placeholder="Account number" id="booknum_openE" value="<?=$numbook?>" disabled>
					</div>
				</div>
			</div>
    </div>
    <div id="menu1" class="tab-pane fade">
				<div class="row">
					<div class="col-md-3">
							<div id="a39" class="form-group">
									...
									<select class="form-control" id="cus_titE" disabled>
					...
					<div class="col-md-3">
							<div id="a40" class="form-group">
									<label>ชื่อผู้ติดต่อ *</label>
										<input type="text" class="form-control border-input" placeholder="Contact Name" id="cus_nameE" value="<?=$cusname?>" disabled>
						...
						<div class="col-md-3">
								<div id="a41" class="form-group">
										<label>นามสกุลผู้ติดต่อ *</label>
											<input type="text" class="form-control border-input" placeholder="Contact Lastname" id="cus_lnameE" value="<?=$cuslname?>" disabled>
						...
						<div class="col-md-3">
							<div id="a42" class="form-group">
									<label>ตำแหน่ง</label>
										<input type="text" class="form-control border-input" placeholder="Contact Position" id="cus_positionE" value="<?=$cusposi?>" disabled>
								</div>
						</div>
				</div>
				<div class="row">
					<div class="col-md-4">
							<div id="a47" class="form-group">
									<label>เลขบัตรประชาชน / เลขที่ผู้เสียภาษี *</label>
										<input type="text" class="form-control border-input" placeholder="ID card / Tax identification number" value="<?=$cusidcrad?>" id="cus_idcardE" maxlength="13" disabled>
						...
						<div class="col-md-3">
								<div id="a48" class="form-group">
										<label>เบอร์โทรศัพท์ผู้ติดต่อ *</label>
											<input type="text" class="form-control border-input" placeholder="Telephone Customer" id="cus_phonecus" value="<?=$cus_phonecus?>" disabled>
					...
					<div class="col-md-5">
							<div id="a43" class="form-group">
									<label>แผนก / ฝ่าย</label>
										<input type="text" class="form-control border-input" placeholder="Contact Department" id="cus_departmentE" value="<?=$cusdepart?>" disabled>
								</div>
						</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4">
							<div id="a49" class="form-group">
									<label>E-mail *</label>
										<input type="email" class="form-control border-input" placeholder="E-mail" id="cus_email" value="<?=$email?>" disabled>
						...
						<div class="col-md-3">
								<div id="a50" class="form-group">
										<label>Line</label>
											<input type="text" class="form-control border-input" placeholder="Line" id="cus_line" value="<?=$line?>" disabled>
					...
					<div class="col-md-5">
							<div id="a51" class="form-group">
									<label>Facebook</label>
										<input type="text" class="form-control border-input" placeholder="Facebook" id="cus_face" value="<?=$face?>" disabled>
								</div>
						</div>
				</div>
				<form id="form1">
					...
					<div class="row">
						<div class="col-md-3">
								<div id="a52" class="form-group">
										<label>คำนำหน้า</label>
										<select class="form-control" id="tit1" disabled>
												<option value="0"> # คำนำหน้า # </option>
						...
						<div class="col-md-4">
								<div id="a53" class="form-group">
										<label>ชื่อ</label>
											<input type="text" class="form-control border-input" placeholder="Name" id="name1" value="<?=$name1?>" disabled>
									</div>
							</div>
							<div class="col-md-4">
									<div id="a54" class="form-group">
											<label>นามสกุล</label>
												<input type="text" class="form-control border-input" placeholder="Lastname" id="lname1" value="<?=$lname1?>" disabled>
										</div>
								</div>
					</div>
					<div class="row">
				<div class="col-md-4">
					<div id="a55" class="form-group">
							<label>รหัสบัตรประชาชน</label>
								<input type="text" class="form-control border-input" placeholder="ID card" id="idcard1" maxlength="13" value="<?=$idcard1?>" disabled>
						</div>
				</div>
						<div class="col-md-5">
							<div id="a56" class="form-group">
									<label>ตำแหน่ง</label>
										<input type="text" class="form-control border-input" placeholder="ID card" id="position1" value="<?=$position1?>" disabled>
								</div>
						</div>
					</div>
				</form>
					...
					<div class="row">
						<div class="col-md-3">
								<div id="a57" class="form-group">
										<label>คำนำหน้า</label>
										<select class="form-control" id="tit2" disabled>
												<option value="0"> # คำนำหน้า # </option>
						...
						<div class="col-md-4">
								<div id="a58" class="form-group">
										<label>ชื่อ</label>
											<input type="text" class="form-control border-input" placeholder="Name" id="name2" value="<?=$name2?>" disabled>
									</div>
							</div>
							<div class="col-md-4">
									<div id="a59" class="form-group">
											<label>นามสกุล</label>
												<input type="text" class="form-control border-input" placeholder="Lastname" id="lname2" value="<?=$lname2?>" disabled>
										</div>
								</div>
					</div>
					<div class="row">
				<div class="col-md-4">
					<div id="a60" class="form-group">
							<label>รหัสบัตรประชาชน</label>
								<input type="text" class="form-control border-input" placeholder="ID card" id="idcard2"  maxlength="13" value="<?=$idcard2?>" disabled>
						</div>
				</div>
						<div class="col-md-5">
							<div id="a61" class="form-group">
									<label>ตำแหน่ง</label>
										<input type="text" class="form-control border-input" placeholder="ID card" id="position2" value="<?=$position2?>" disabled>
								</div>
						</div>
					</div>
				</form>
					...
					<div class="row">
						<div class="col-md-3">
								<div id="a62" class="form-group">
										<label>คำนำหน้า</label>
										<select class="form-control" id="tit3" disabled>
												<option value="0"> # คำนำหน้า # </option>
						...
						<div class="col-md-4">
								<div id="a63" class="form-group">
										<label>ชื่อ</label>
											<input type="text" class="form-control border-input" placeholder="Name" id="name3" value="<?=$name3?>" disabled>
									</div>
							</div>
							<div class="col-md-4">
									<div id="a64" class="form-group">
											<label>นามสกุล</label>
												<input type="text" class="form-control border-input" placeholder="Lastname" id="lname3" value="<?=$lname3?>" disabled>
										</div>
								</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div id="a65" class="form-group">
									<label>รหัสบัตรประชาชน</label>
										<input type="text" class="form-control border-input" placeholder="ID card" id="idcard3"  maxlength="13" value="<?=$idcard3?>"disabled>
								</div>
						</div>
						<div class="col-md-5">
							<div id="a66" class="form-group">
									<label>ตำแหน่ง</label>
										<input type="text" class="form-control border-input" placeholder="ID card" id="position3" value="<?=$position3?>"disabled>
								</div>
						</div>
					</div>
				</form>
					...
					<div class="col-md-3">
						...
						<div class="col-md-3">
							<div id="a67" class="form-group">
										...
										<select class="form-control" id="considerationE" disabled>
				...
				<div class="row">
					<div class="col-md-6">
							<div id="a68" class="form-group">
									...
									<input type="text" class="form-control border-input" placeholder="Sale Name" id="sale_name_cusE"  value="<?=$crd2_sellname?>" disabled>
								</div>
						</div>
					<div class="col-md-3">
						<div id="a69" class="form-group">
									<label>สาขา *</label>
									<select class="form-control" id="sale_branch_cusE" disabled>
					...
					<div id="a46" class="col-md-12">
							<div class="form-group">
									<label>ความเห็นผู้แทนขาย</label>
										<textarea class="form-control border-input notes" placeholder="Sele Comment" id="sale_commentE" rows="5" disabled><?=$comment?></textarea>
								</div>
						</div>
				</div>
		</div>
